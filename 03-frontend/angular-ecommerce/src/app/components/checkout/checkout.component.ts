...
export class CheckoutComponent {
  ...
  ngOnInit(): void {
    ...
    //populate credit card months -- not needed anymore, because of Stripe integration:
    /*
...
*/
  ...
  setupStripePaymentForm() {
    ...
    //create a card element ... add hide the zip code field
  ...
  onSubmit() {
    ...
    //populate purcahse - shipping address
    ...
    //populate purcahse - billing address
